...
VARIABLE_FONT_FAMILIES = {
    ...
    "serif": ['"Roboto Slab"', '"Fraunces"', '"Source Serif 4"'],
    "mono": ['"Cascadia Code"', '"Recursive"'],
    "display": ['"Raleway"', '"Unbounded"', '"Barlow"'],
    "humanist": ['"Public Sans"', '"Atkinson Hyperlegible"', '"Work Sans"'],
