...
from .html_utils import extract_body_content_with_inline_safe_styles, minify_output_html
...
def build_variant(
    ...
    content_html = extract_body_content_with_inline_safe_styles(content_html, strict_mode=strict_mode)
